...
plot(as.network(simple_edge_df))
...
plot(as.network(simple_edge_df, vertices = simple_vertex_df))
...
plot(as.network(bip_edge_df, directed = FALSE, bipartite = TRUE))
plot(as.network(bip_edge_df, directed = FALSE, vertices = bip_node_df, bipartite = TRUE))
